...
export default function MobileCard({ item, state, now, clientColor, dragging, overlay, onClick }: Props) {
  ...
  return (
    ...
    >
      ...
      {/* título */}
      <Typography sx={{
        fontSize: '0.82rem', fontWeight: 700, color: DS.t1, lineHeight: 1.25,
