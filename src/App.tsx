...
import { DATA, DATA_JULHO, DATA_AGOSTO, DATA_SETEMBRO, DATA_OUTUBRO, DATA_NOVEMBRO, DATA_DEZEMBRO, CLIENTS } from './data'
import {
...
export default function App() {
  ...
  const allItems = useMemo((): ContentItem[] => {
    return [...DATA, ...DATA_JULHO, ...DATA_AGOSTO, ...DATA_SETEMBRO, ...DATA_OUTUBRO, ...DATA_NOVEMBRO, ...DATA_DEZEMBRO, ...customItems]
