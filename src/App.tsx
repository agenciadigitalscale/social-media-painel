...
export default function App() {
  ...
  const renderTab = () => {
    switch (tab) {
      ...
      case 2: return <KanbanTab   items={allItems} states={states} onStatusChange={setStatus} onDelete={deleteItem} onEdit={editItem} onUpdate={updateItem} onAddItem={addItem} allClients={allClients} />
