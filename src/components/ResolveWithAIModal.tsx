  ...
  return (
    ...
    >
      ...
      <DialogContent sx={{ pt: 2, pb: 1 }}>
        ...
        {/* Content item info */}
        <Paper sx={{ p: 1.5, mb: 2, bgcolor: 'rgba(255,255,255,0.025)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: 2 }}>
        ...
        {/* Action buttons */}
        <Typography sx={{ fontSize: '0.6rem', fontWeight: 800, textTransform: 'uppercase', letterSpacing: 1, color: 'rgba(255,255,255,0.3)', mb: 1 }}>
          ...
          {ACTIONS.map(action => (
            <Paper
              ...
              sx={{
                ...
                bgcolor: selectedAction === action.id ? `${action.color}12` : 'rgba(255,255,255,0.025)',
                border: `1px solid ${selectedAction === action.id ? `${action.color}40` : 'rgba(255,255,255,0.06)'}`,
            ...
            >
              ...
              <Typography sx={{ fontWeight: 700, fontSize: '0.78rem', color: selectedAction === action.id ? action.color : 'rgba(255,255,255,0.8)', lineHeight: 1.2 }}>
                {action.label}
              </Typography>
              <Typography sx={{ fontSize: '0.6rem', color: 'rgba(255,255,255,0.3)', mt: 0.2, lineHeight: 1.3 }}>
                {action.description}
              </Typography>
            </Paper>
          ))}
        ...
        {result && !loading && (
          <Box>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 1 }}>
              <Typography sx={{ fontSize: '0.6rem', fontWeight: 800, textTransform: 'uppercase', letterSpacing: 1, color: 'rgba(255,255,255,0.3)', flex: 1 }}>
                Resultado
              </Typography>
              <Button
                size="small"
            ...
            <Paper sx={{
              ...
              <Typography sx={{ fontSize: '0.82rem', color: 'rgba(255,255,255,0.82)', lineHeight: 1.8, whiteSpace: 'pre-wrap' }}>
                {result}
              </Typography>
            </Paper>
