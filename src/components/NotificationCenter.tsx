      ...
      >
        ...
        <Box sx={{
          ...
          {unread > 0 && (
            <Chip
              ...
              size="small"
              sx={{ fontSize: '0.58rem', height: 18, bgcolor: 'rgba(239,68,68,0.15)', color: DS.red, border: '1px solid rgba(239,68,68,0.3)' }}
            />
          )}
        ...
        <Box sx={{ overflowY: 'auto', flex: 1 }}>
          {sorted.length === 0 ? (
            ...
            sorted.map((notif, i) => {
              const color = TYPE_COLOR[notif.type] ?? DS.neutral
