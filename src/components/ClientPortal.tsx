...
import { DATA, DATA_JULHO, DATA_AGOSTO, DATA_SETEMBRO, DATA_OUTUBRO, DATA_NOVEMBRO, DATA_DEZEMBRO, DATA_JANEIRO } from '../data'
...
export default function ClientPortal({ token }: { token: string }) {
  ...
  const monthItems = useMemo(() => {
    ...
    return [...DATA, ...DATA_JULHO, ...DATA_AGOSTO, ...DATA_SETEMBRO, ...DATA_OUTUBRO, ...DATA_NOVEMBRO, ...DATA_DEZEMBRO, ...DATA_JANEIRO, ...data.customItems]
